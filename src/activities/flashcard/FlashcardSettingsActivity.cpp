...
void FlashcardSettingsActivity::onEnter() {
    Activity::onEnter();
    newPerDay = CROSSPET_SETTINGS.flashcardNewPerDay;
    maxReview = CROSSPET_SETTINGS.flashcardMaxReviewPerDay;
...
void FlashcardSettingsActivity::saveSettings() {
    CROSSPET_SETTINGS.flashcardNewPerDay = newPerDay;
    CROSSPET_SETTINGS.flashcardMaxReviewPerDay = maxReview;
    CROSSPET_SETTINGS.saveToFile();
}
